...
impl Instruction {
    pub fn decode(opcode: u8, reader: &mut impl FnMut() -> u8) -> Self {
        match opcode {
            // --- 0x00 - 0x0F ---
            0x00 => Self::NOP,
            0x01 => Self::LD_16_IMM(Reg16::BC, Self::read_u16(reader)),
            0x02 => Self::LD_BC_A,
            0x03 => Self::INC_16(Reg16::BC),
            0x04 => Self::INC_8(Reg8::B),
            0x05 => Self::DEC_8(Reg8::B),
            0x06 => Self::LD_8_IMM(Reg8::B, reader()),
            0x07 => Self::RLCA,
            0x08 => Self::LD_IMM_16_SP(Self::read_u16(reader)),
            0x09 => Self::ADD_16(Reg16::BC),
            0x0A => Self::LD_A_BC,
            0x0B => Self::DEC_16(Reg16::BC),
            0x0C => Self::INC_8(Reg8::C),
            0x0D => Self::DEC_8(Reg8::C),
            0x0E => Self::LD_8_IMM(Reg8::C, reader()),
            0x0F => Self::RRCA,
            ...
            0x11 => Self::LD_16_IMM(Reg16::DE, Self::read_u16(reader)),
            0x12 => Self::LD_DE_A,
            0x13 => Self::INC_16(Reg16::DE),
            0x14 => Self::INC_8(Reg8::D),
            0x15 => Self::DEC_8(Reg8::D),
            0x16 => Self::LD_8_IMM(Reg8::D, reader()),
            0x17 => Self::RLA,
            0x18 => Self::JR(Condition::None, reader() as i8),
            0x19 => Self::ADD_16(Reg16::DE),
            0x1A => Self::LD_A_DE,
            0x1B => Self::DEC_16(Reg16::DE),
            0x1C => Self::INC_8(Reg8::E),
            0x1D => Self::DEC_8(Reg8::E),
            0x1E => Self::LD_8_IMM(Reg8::E, reader()),
            0x1F => Self::RRA,

            // --- 0x20 - 0x2F ---
            0x20 => Self::JR(Condition::NZ, reader() as i8),
            0x21 => Self::LD_16_IMM(Reg16::HL, Self::read_u16(reader)),
            0x22 => Self::LD_HLI_A,
            0x23 => Self::INC_16(Reg16::HL),
            0x24 => Self::INC_8(Reg8::H),
            0x25 => Self::DEC_8(Reg8::H),
            0x26 => Self::LD_8_IMM(Reg8::H, reader()),
            0x27 => Self::DAA,
            0x28 => Self::JR(Condition::Z, reader() as i8),
            0x29 => Self::ADD_16(Reg16::HL),
            0x2A => Self::LD_A_HLI,
            0x2B => Self::DEC_16(Reg16::HL),
            0x2C => Self::INC_8(Reg8::L),
            0x2D => Self::DEC_8(Reg8::L),
            0x2E => Self::LD_8_IMM(Reg8::L, reader()),
            0x2F => Self::CPL,

            // --- 0x30 - 0x3F ---
            0x30 => Self::JR(Condition::NC, reader() as i8),
            0x31 => Self::LD_16_IMM(Reg16::SP, Self::read_u16(reader)),
            0x32 => Self::LD_HLD_A,
            0x33 => Self::INC_16(Reg16::SP),
            0x34 => Self::INC_8(Reg8::HLIndirect),
            0x35 => Self::DEC_8(Reg8::HLIndirect),
            0x36 => Self::LD_8_IMM(Reg8::HLIndirect, reader()),
            0x37 => Self::SCF,
            0x38 => Self::JR(Condition::C, reader() as i8),
            0x39 => Self::ADD_16(Reg16::SP),
            0x3A => Self::LD_A_HLD,
            0x3B => Self::DEC_16(Reg16::SP),
            0x3C => Self::INC_8(Reg8::A),
            0x3D => Self::DEC_8(Reg8::A),
            0x3E => Self::LD_8_IMM(Reg8::A, reader()),
            0x3F => Self::CCF,

            // --- 0x40 - 0x7F ---
            0x40..=0x75 | 0x77..=0x7F => {
                Self::LD_8(Self::map_reg8(opcode >> 3), Self::map_reg8(opcode))
            }
            0x76 => Self::HALT,

            // --- 0x80 - 0xBF ---
            0x80..=0x87 => Self::ADD(Self::map_reg8(opcode)),
            0x88..=0x8F => Self::ADC(Self::map_reg8(opcode)),
            0x90..=0x97 => Self::SUB(Self::map_reg8(opcode)),
            0x98..=0x9F => Self::SBC(Self::map_reg8(opcode)),
            0xA0..=0xA7 => Self::AND(Self::map_reg8(opcode)),
            0xA8..=0xAF => Self::XOR(Self::map_reg8(opcode)),
            0xB0..=0xB7 => Self::OR(Self::map_reg8(opcode)),
            0xB8..=0xBF => Self::CP(Self::map_reg8(opcode)),

            // --- 0xC0 - 0xCF ---
            0xC0 => Self::RET(Condition::NZ),
            0xC1 => Self::POP(Reg16::BC),
            0xC2 => Self::JP(Condition::NZ, Self::read_u16(reader)),
            0xC3 => Self::JP(Condition::None, Self::read_u16(reader)),
            0xC4 => Self::CALL(Condition::NZ, Self::read_u16(reader)),
            0xC5 => Self::PUSH(Reg16::BC),
            0xC6 => Self::ADD_IMM(reader()),
            0xC7 => Self::RST(0x00),
            0xC8 => Self::RET(Condition::Z),
            0xC9 => Self::RET(Condition::None),
            0xCA => Self::JP(Condition::Z, Self::read_u16(reader)),
            0xCB => Self::PREFIX_CB(reader()),
            0xCC => Self::CALL(Condition::Z, Self::read_u16(reader)),
            0xCD => Self::CALL(Condition::None, Self::read_u16(reader)),
            0xCE => Self::ADC_IMM(reader()),
            0xCF => Self::RST(0x08),

            // --- 0xD0 - 0xDF ---
            0xD0 => Self::RET(Condition::NC),
            0xD1 => Self::POP(Reg16::DE),
            0xD2 => Self::JP(Condition::NC, Self::read_u16(reader)),
            0xD4 => Self::CALL(Condition::NC, Self::read_u16(reader)),
            0xD5 => Self::PUSH(Reg16::DE),
            0xD6 => Self::SUB_IMM(reader()),
            0xD7 => Self::RST(0x10),
            0xD8 => Self::RET(Condition::C),
            0xD9 => Self::RETI,
            0xDA => Self::JP(Condition::C, Self::read_u16(reader)),
            0xDC => Self::CALL(Condition::C, Self::read_u16(reader)),
            0xDE => Self::SBC_IMM(reader()),
            0xDF => Self::RST(0x18),

            // --- 0xE0 - 0xEF ---
            0xE0 => Self::LDH_IMM_A(reader()),
            0xE1 => Self::POP(Reg16::HL),
            0xE2 => Self::LDH_C_A,
            0xE5 => Self::PUSH(Reg16::HL),
            0xE6 => Self::AND_IMM(reader()),
            0xE7 => Self::RST(0x20),
            0xE8 => Self::ADD_16_SP_e8(reader() as i8),
            0xE9 => Self::JP_HL,
            0xEA => Self::LD_IMM_16_A(Self::read_u16(reader)),
            0xEE => Self::XOR_IMM(reader()),
            0xEF => Self::RST(0x28),

            // --- 0xF0 - 0xFF ---
            0xF0 => Self::LDH_A_IMM(reader()),
            0xF1 => Self::POP(Reg16::AF),
            0xF2 => Self::LDH_A_C,
            0xF3 => Self::DI,
            0xF5 => Self::PUSH(Reg16::AF),
            0xF6 => Self::OR_IMM(reader()),
            0xF7 => Self::RST(0x30),
            0xF8 => Self::LD_HL_SP_e8(reader() as i8),
            0xF9 => Self::LD_SP_HL,
            0xFA => Self::LD_A_IMM_16(Self::read_u16(reader)),
            0xFB => Self::EI,
            0xFE => Self::CP_IMM(reader()),
            0xFF => Self::RST(0x38),
    ...
    /// Maps a u8 to a 1B register [`Reg8`]
